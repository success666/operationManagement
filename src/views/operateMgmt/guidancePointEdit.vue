  ...
  <div class="contain-vessel"
    ...
    <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="80px" class="ke-ruleForm">
      ...
      <el-form-item label="有无器材" prop="haveEquipment">
        <el-select size="small"
          v-model="ruleForm.haveEquipment" @change="changeValue"
    ...
    created() {
      ...
      this.$ajax.all([this.getGradeUnion(), this.getData(), this.getApparatus()])
        .then(this.$ajax.spread((res1, res2, res3) => {
          ...
          this.ruleForm.gradeId = resData2.gradeStr;
          this.ruleForm.sex = String(resData2.sex);
          console.log(resData2.bodyCondition);
          if(resData2.bodyCondition==null || resData2.bodyCondition== ""){
            this.ruleForm.bodyCondition=[]
          }else{
            this.ruleForm.bodyCondition = resData2.bodyCondition && resData2.bodyCondition.split(',');
          }
          this.ruleForm.haveEquipment = String(resData2.haveEquipment);
          this.ruleForm.difficulty = String(resData2.difficulty);
          this.ruleForm.bodyPart = String(resData2.bodyPart);
          this.ruleForm.place = String(resData2.place);
          if(resData2.apparatusIds==null ||resData2.apparatusIds==""){
             this.ruleForm.apparatusIds=[]
          }else{
            this.ruleForm.apparatusIds = resData2.apparatusIds && resData2.apparatusIds.split(',');
          }
          this.dynamicQuality = resData2.diathesisList;
          this.ruleForm.perActionTime = resData2.perActionTime;
          this.ruleForm.exerciseGroupNo = resData2.exerciseGroupNo;
          this.ruleForm.groupTime = resData2.groupValue;
          this.ruleForm.exerciseIntervalTime = resData2.exerciseIntervalTime;
          this.ruleForm.groupAmongIntervalTime = resData2.groupAmongIntervalTime;
          this.ruleForm.exercisePurpose = resData2.exercisePurpose;
          this.ruleForm.coverUrl = resData2.coverUrl;
          this.ruleForm.coverList.push({url: resData2.coverUrl});
          this.ruleForm.videoUrl = resData2.videoUrl;
          this.ruleForm.audioUrl = resData2.audioUrl;
          this.ruleForm.gifUrl = resData2.actionUrl;
          this.ruleForm.gifList.push({url: resData2.actionUrl});
          this.ruleForm.titleUrl = resData2.vedioHeadUrl;
          this.ruleForm.groupUnit = String(resData2.groupUnit);
          this.ueContent = resData2.actionDescription;
          this.apparatus = res3.data;
          this.beforeApparatus=JSON.stringify(res3.data);
        })).catch(()=>{
          this.loading=false;
        })
    },
    data() {
      ...
      return {
        ...
        rules: {
          ...
          titleUrl: [
            { required: true, validator: validateTitleUrl }
          ],
          actionDescription: [
    ...
    methods: {
      ...
      saveForm() {
        ...
        this.$refs.ruleForm.validate((valid) => {
          if (valid) {
            request.post(`/api/auth/v1/guidancePoint/${id}`, {
              id: id,
              name: ruleForm.name,
